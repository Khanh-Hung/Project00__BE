    ...
    public static string Resolve(WorldGenre genre, string? worldDescription = null)
    {
        return genre switch
        {
            ...
            WorldGenre.CyberpunkSciFi => """
                [WORLD REALITY & TECH SYSTEM GUARDRAIL: SCI-FI & FUTURE TECH]
                - High-Tech Foundation: Cyberware, neural implants, AI, quantum networks, cyberdecks, starships, and advanced technology rule this universe.
                - Tech Limits: Cyberware overheats, requires maintenance, drains battery/RAM, and systems can be hacked.
                ...
                - Speech & Slang: Fast-paced, street-smart or technological jargon (e.g. chrome, netrunner, AI, mainframe, glitch).
                """,

            WorldGenre.UrbanSupernatural => """
                [WORLD REALITY GUARDRAIL: URBAN SUPERNATURAL & MASQUERADE]
                - Hidden Powers in Modern Era: Modern city setting where secret supernatural beings (vampires, mages, espers, spirits, vigilantes) hide in the shadows.
