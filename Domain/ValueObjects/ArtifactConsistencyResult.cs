...
/// Contains authoritative status, session identifier, current artifact pointer, expected artifact pointer,
/// expected generation job ID, expected visual revision, and diagnostic reason.
/// </summary>
public sealed record ArtifactConsistencyResult(
    ...
    int? ExpectedVisualRevision = null
);
