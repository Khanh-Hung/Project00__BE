...
public sealed class CharacterDesirePolicy : ICharacterDesirePolicy
{
        ...
        CharacterEmotion emotion)
    {
        ...
        var desires = new List<CharacterDesire>(6);
        ...
        // - Emotion (PR40) acts as an amplifier (+0.15 * emotion.Intensity) or suppressor (-0.15 * emotion.Intensity).
        // - Emotion NEVER creates a desire if the underlying base need is 0.0.
        ...
        // Precedence: NeedSafety > NeedFood > NeedRest > NeedReduceStress > NeedSocialConnection > NeedComfort
    ...
    private static CharacterDesire CreateFoodDesire(
        ...
        CharacterEmotion emotion)
    {
        double hungerPressure = exp.Hunger.Intensity.Value;
        double intensity = ApplyEmotionModulation(hungerPressure, DesireSource.Hunger, appraisal, emotion);
    ...
    private static CharacterDesire CreateRestDesire(
        ...
        CharacterEmotion emotion)
    {
        // In PR39, Energy.Intensity represents perceived Fatigue deficit intensity:
        // Energy = 0 -> Fatigue = 1.0; Energy = 100 -> Fatigue = 0.0.
        double fatigueIntensity = exp.Energy.Intensity.Value;
        double intensity = ApplyEmotionModulation(fatigueIntensity, DesireSource.Energy, appraisal, emotion);
    ...
    private static CharacterDesire CreateStressReliefDesire(
        ...
        CharacterEmotion emotion)
    {
        double stressPressure = exp.Stress.Intensity.Value;
        double intensity = ApplyEmotionModulation(stressPressure, DesireSource.Stress, appraisal, emotion);
    ...
    private static CharacterDesire CreateSocialDesire(
        ...
        CharacterEmotion emotion)
    {
        double socialNeedPressure = exp.SocialNeed.Intensity.Value;
        double intensity = ApplyEmotionModulation(socialNeedPressure, DesireSource.SocialNeed, appraisal, emotion);
    ...
    private static CharacterDesire CreateComfortDesire(
        ...
        CharacterEmotion emotion)
    {
        // In PR39, Comfort.Intensity represents perceived Discomfort deficit intensity:
        // Comfort = 0 -> Discomfort = 1.0; Comfort = 100 -> Discomfort = 0.0.
        double discomfortIntensity = exp.Comfort.Intensity.Value;
        double intensity = ApplyEmotionModulation(discomfortIntensity, DesireSource.Comfort, appraisal, emotion);
        ...
        CharacterEmotion emotion)
    {
        ...
        // 1. Amplification Rules (additive boost, avoiding double-counting)
    ...
    private static CharacterDesire SelectDominantDesire(IReadOnlyList<CharacterDesire> desires)
    {
        ...
        // NeedSafety > NeedFood > NeedRest > NeedReduceStress > NeedSocialConnection > NeedComfort
