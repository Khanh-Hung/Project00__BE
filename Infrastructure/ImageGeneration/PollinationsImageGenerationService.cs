...
public sealed class PollinationsImageGenerationService : IImageGenerationService
{
    ...
    public async Task<string> GenerateImageAsync(
        ...
        CancellationToken ct = default)
    {
        var finalPrompt = request.Prompt.Trim();
        var defaultNegative = "sleepy eyes, half-closed eyes, narrow eyes, squinting, heavy makeup, duck face, pout, plastic skin, doll, uncanny, creepy, alien face, deformed, bad eyes, bad mouth, blurry, extra fingers, mutated anatomy";
