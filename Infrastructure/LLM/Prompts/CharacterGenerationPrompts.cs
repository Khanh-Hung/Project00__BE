...
public static class CharacterGenerationPrompts
{
    public const string ProfileSystemPrompt = """
        ...
        Yêu cầu bắt buộc: Phải trả về DUY NHẤT một chuỗi JSON hợp lệ theo đúng cấu trúc sau:
        {
          ...
          "worldGenre": 1, // Điền số 1 - 5: 1 (MundaneSliceOfLife - Đời thường không phép thuật), 2 (HighFantasy - Phép thuật/Tu tiên), 3 (CyberpunkSciFi - Công nghệ tương lai), 4 (UrbanSupernatural - Đô thị siêu nhiên), 5 (Historical - Lịch sử cổ trang)
