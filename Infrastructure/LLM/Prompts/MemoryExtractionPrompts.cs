...
public static class MemoryExtractionPrompts
{
    public static string BuildExtractionSystemPrompt(Character character)
    {
        return $$"""
            ...
            Your job is to analyze the recent conversation excerpt between the User and {{character.Name}}, and extract ONLY 0 to 2 high-value, long-term memory candidates about the User, their relationship, and key factual events.
            ...
            - Casual greetings, small talk ("hi", "how are you", "good morning").
